...
Discourse::Application.routes.draw do
  ...
  %w{users u}.each_with_index do |root_path, index|
    ...
    get "#{root_path}/:username/preferences/verify-id-card" => "users#preferences", constraints: {username: USERNAME_ROUTE_FORMAT}
    get "#{root_path}/:username/preferences/verify-passport" => "users#preferences", constraints: {username: USERNAME_ROUTE_FORMAT}
